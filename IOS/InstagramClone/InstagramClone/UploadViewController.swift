                ...
                if error != nil{
                    ...
                    imageReference.downloadURL { [self] url, error in
                        if error != nil{
                            ...
                            let firestorePost = ["imageUrl" : imageUrl! ,"postedBy" : Auth.auth().currentUser!.email!,"postComment" : textField.text! , "date" : FieldValue.serverTimestamp() , "likes" : 0] as [String : Any]
